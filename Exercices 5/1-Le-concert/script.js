...
concertRoom.forEach((index) => console.log(`Salut ${index.name}, le concert commencera d'ici deux heures !`))
...
// concertRoom.forEach((el) => console.log(`Salut ${el.name}, le concert commencera d'ici deux heures !`))
